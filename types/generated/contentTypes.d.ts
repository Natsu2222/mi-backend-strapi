...
export interface ApiAcuarioAcuario extends Struct.CollectionTypeSchema {
  collectionName: 'acuarios';
  info: {
    displayName: 'acuario';
    pluralName: 'acuarios';
    singularName: 'acuario';
  };
  options: {
...
export interface ApiBanerBaner extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    acuarios: Schema.Attribute.Relation<'oneToMany', 'api::acuario.acuario'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text & Schema.Attribute.Required;
...
export interface ApiFishFish extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    image: Schema.Attribute.Media<'images'> & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::fish.fish'> &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    price: Schema.Attribute.Decimal;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::acuario.acuario': ApiAcuarioAcuario;
